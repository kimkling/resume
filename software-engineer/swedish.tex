...
\textbf{Projekt}: Volvo On Call för nästa generationen bilar - Volvo Car AB, In-Car apps Volvo Car AB \& Molntjänster för biltillverkare - WirelessCar AB.} \\
\multicolumn{2}{c}{} \\

%------------------------------------------------

\textsc{Apr 2021} |	                & Mjukvaruutveckling på \textsc{Egen firma} \hfill Göteborg, Sverige \\
